...
```bibtex
@ARTICLE{Lei2025SLAFormer,
  author={Lei, Tao and Zhou, Qiong and Liu, Tongfei and Zhang, Shuxin and Wang, Yingbo and Liu, Daqi and Gong, Maoguo},
  journal={IEEE Transactions on Geoscience and Remote Sensing}, 
  title={SLAFormer: Skeleton-Guided Large-Kernel Attention Transformer for Road Change Detection}, 
  year={2025},
  volume={63},
  number={},
  pages={1-15},
